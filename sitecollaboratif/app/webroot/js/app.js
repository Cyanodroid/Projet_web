...
function ajaxCall() {
	...
	var params = current_url.substring(current_url.indexOf("id:")+3);
...
// source de la fonction suivante : http://www.vingtseptpointsept.fr/2011/09/22/une-fonction-javascript-pour-eliminer-accents-et-diacritiques/
...
function EnvoyerMSG(id) {
	...
	var msg_sans_accents = remplace_diacritiques_latins(str);
	var msg = sanitize_badwords(msg_sans_accents);
