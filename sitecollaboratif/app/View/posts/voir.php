<?php
    ...
    //affichage du titre, de la catégorie, de la date et de l'image de l'article (si il n'en possède pas, une image est assignée de base)
    ...
    echo("<div class=\"col-lg-8\">");
        ...
        //partie gallerie avec toutes les images de l'article
        if ($cpt > 1) {
            echo("<hr>");
            echo("<h3>");
            echo __("Gallerie");
        ...
        //partie commentaire : publication d'un commentaire
    	echo("<div class=\"well\">");
            echo("<h4>");
        ...
        //partie commentaire : liste des commentaires existants
    	foreach ($c as $com){
    ...
    //partie partage sur réseaux sociaux (twitter, facebook, google+, flux rss)
