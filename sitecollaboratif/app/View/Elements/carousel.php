<?php
	...
	//récupération des trois derniers articles (titre, image principale, résumé, lien) et organisation en slides du carousel
		  	for ($i = 0; $i < 3; $i++){
	...
	//flèches "gauche" et "droite" du carousel
